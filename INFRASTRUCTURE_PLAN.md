...
|---|---|---|---|
| ⬜ | [#84](https://github.com/hoferan/miniyard/issues/84) | ESLint 10 + eslint-config-next 16 coordinated upgrade | Close Dependabot PRs #29 and #52 first; upgrade both packages together in one branch |
| ⬜ | [#43](https://github.com/hoferan/miniyard/issues/43) | Add CONTRIBUTING.md, trim README, add `.vscode/launch.json` | Pure docs/DevEx, zero risk |
...
| Status | Issue | Title | Notes |
|---|---|---|---|
| ⬜ | [#28](https://github.com/hoferan/miniyard/issues/28) | Breadcrumbs on category listing pages | Generalize existing `ModuleBreadcrumb` component |
